...
namespace
{
    ...
    $manifest = file_get_contents('http://silvadanilo.github.io/kbize/manifest.json');
    ...
    echo " - Downloading Kbize v", Dumper::toString($item->version), "...$n";
    ...
    echo " - Making Kbize executable...$n";

    @chmod($item->name, 0755);

    echo "{$n}Kbize installed!$n";
